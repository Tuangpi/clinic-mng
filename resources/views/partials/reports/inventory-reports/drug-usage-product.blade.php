<div id="drugUsageProductReportContainer" class="no-print">
    <hr class="bg-gray-600 opacity-2 no-print" />

    <h4>Drug Usage (Product) from {{ $startDate }} to {{ $endDate }}</h4>
    <div class="table-responsive">
        <table id="drugUsageProductTable" class="table table-bordered table-striped table-hover w-100">
            <thead>
                <tr>
                    <th>Item ID</th>
                    <th>Item Name</th>
