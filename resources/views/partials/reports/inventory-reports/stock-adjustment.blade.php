<div id="stockAdjustmentReportContainer" class="no-print">
    <hr class="bg-gray-600 opacity-2 no-print" />

    <h4>Stock Adjustment from {{ $startDate }} to {{ $endDate }}</h4>
    <div class="table-responsive">
        <table id="stockAdjustmentTable" class="table table-bordered table-striped table-hover w-100">
            <thead>
                <tr>
                    <th>Date</th>
                    <th>Adjustment ID</th>
